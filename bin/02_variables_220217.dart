main() {
  ...
  final strites = <String>['', '', ''];
  dynamic errorMessage = 'Hola';
  errorMessage = 23;
  errorMessage = true;
  errorMessage = [1, 2, 3, 4, 5, 6, 7];
  errorMessage = {1, "Hola", 4.3, 'a', false};
  errorMessage = () => true;
  errorMessage = null;

  print("""
  $pokemon $hp $isAlive $abilities $strites $errorMessage
  """);

  // 2. Interpolacion (Lectura de valores almacenados)

  print("Este cabron es gay: $nombre");
